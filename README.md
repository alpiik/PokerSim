...
**Live site:** https://alpiik.github.io/PokerSim/

## Usage

Open `index.html` in any modern browser, or use the live site linked above.
...
```
index.html            Main page (Vue UI + odds calculation logic)
...
`Simulator.java` and the JavaScript in `index.html` both implement the same Monte Carlo approach independently:
